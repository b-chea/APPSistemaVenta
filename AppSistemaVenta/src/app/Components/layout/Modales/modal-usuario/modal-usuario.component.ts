    ...
    if(this.datosUsuario == null){
      this._usuarioServicio.guardar(_usuario).subscribe({
        ...
        error: (e)=>{
          ...
          this._utilidadServicio.mostrarAlerta("Hubo un error al guardar el usuario", "Error");
        }
      });
    }else{
      this._usuarioServicio.editar(_usuario).subscribe({
        ...
        error: (e)=>{
          ...
          this._utilidadServicio.mostrarAlerta("Hubo un error al editar el usuario", "Error");
        }
      });
    }
  }
